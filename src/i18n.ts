...
const en = {
  ...
  'news.next': 'Next ⏭',
  'god.title': 'God Mode',
  'god.subtitle': 'You are no longer a spectator. Strike, bless, or reshape the fate of nations.',
  'god.sanction': '⚡ Sanction',
  'god.sanctionDesc': 'Crush a civilization\u2019s economy',
  'god.aid': '💰 Divine aid',
  'god.aidDesc': 'Bless a civilization with prosperity',
  'god.provoke': '⚔️ Provoke war',
  'god.provokeDesc': 'Force two rivals into war',
  'god.peace': '🕊️ Impose peace',
  'god.peaceDesc': 'End all wars of a civilization',
  'god.pickTarget': 'Choose your target',
  'god.pickTwo': 'Choose two rivals',
  'god.confirm': '⚡ Intervene!',
  'timelapse.title': 'History Timelapse',
  'timelapse.play': '▶ Replay',
  'timelapse.pause': '⏸ Pause',
  'timelapse.empty': 'Play a few turns first — history is being written.',
  'time.timelapse': '⏪ Timelapse',
  'ctrl.soundOn': '🔊 Sound',
  'ctrl.soundOff': '🔇 Muted',
  'ctrl.god': '🎮 God',
};
...
const fa: Strings = {
  ...
  'news.breaking': 'خبر فوری',
  'news.next': '⏭ ادامه',
  'god.title': 'حالت خدا',
  'god.subtitle': 'دیگر تماشاچی نیستی. بزن، برکت بده، یا سرنوشت ملت‌ها را دگرگون کن.',
  'god.sanction': '⚡ تحریم',
  'god.sanctionDesc': 'اقتصاد یک تمدن را در هم بکوب',
  'god.aid': '💰 کمک الهی',
  'god.aidDesc': 'یک تمدن را با شکوفایی برکت بده',
  'god.provoke': '⚔️ تحریک جنگ',
  'god.provokeDesc': 'دو رقیب را به جنگ وادار کن',
  'god.peace': '🕊️ تحمیل صلح',
  'god.peaceDesc': 'به همه‌ی جنگ‌های یک تمدن پایان بده',
  'god.pickTarget': 'هدفت را انتخاب کن',
  'god.pickTwo': 'دو رقیب انتخاب کن',
  'god.confirm': '⚡ دخالت کن!',
  'timelapse.title': 'تایم‌لپس تاریخ',
  'timelapse.play': '▶ پخش',
  'timelapse.pause': '⏸ توقف',
  'timelapse.empty': 'اول چند نوبت بازی کن — تاریخ در حال نوشته شدن است.',
  'time.timelapse': '⏪ تایم‌لپس',
  'ctrl.soundOn': '🔊 صدا',
  'ctrl.soundOff': '🔇 بی‌صدا',
  'ctrl.god': '🎮 خدا',
};
